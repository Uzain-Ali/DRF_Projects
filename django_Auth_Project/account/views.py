...
from .serializers import UserRegistrationSerializer, UserLoginSerializer, UserProfileSerializers, UserChangePasswordSerializer,UserResetPasswordEmailSerializer, UserResetPasswordSerializer
...
class UserRegisterationView(APIView):
    ...
    def post(self, request, format = None):
        ...
        return Response({'token':token, 'msg':'Registration Sucscess'}, status=status.HTTP_201_CREATED)
